<template>
  <v-card elevation="0">
    <v-card-title>
      <h3 style="font-weight: 700;">Subscription Plans</h3> 
      <v-spacer></v-spacer>
...
export default class Users extends Vue {
  ...
  itemToDelete: SubscriptionPlan | null = null;
  ...
  headers = [
    ...
    // active: true
    // createdAt: "2021-08-29T08:31:40.738Z"
    // id: "612b45ec3beda74568de769c"
    // intervalCount: 1
    // intervalUnit: "WEEK"
    // modifiedAt: "2021-08-29T09:50:04.431Z"
    // name: "Every 7 Days"
    // operationId: "612b45e83beda74568de766b"
    // paypalPlanId: "P-9DL572758F092771MMEVVQTA"
    // topupAmountId: "612b45ea3beda74568de766f"
  ];
  subscriptoinPlans: PaymentProvider[] = [];

  async fetchUsers() {
    this.loadingUses = true;
    const res = await Resource.subscriptionPlans.getSubscriptionPlans().get();
  ...
  setItemToDelete(item: SubscriptionPlan) {
    this.itemToDelete = item;
    this.deleteConfirmationDialog = true;
  }

  updateUser(item: SubscriptionPlan) {
    this.$router.push({
